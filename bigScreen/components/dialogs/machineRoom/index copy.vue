<template>
  <el-dialog v-model="visible" class="screen-dark-dialog" :show-close="false" append-to-body width="1000">
    ...
    <div v-loading="loading" class="machine-room-content max-h-[70vh]">
      <div class="content-left w-[428px] flex flex-col min-h-0">
        <div class="info-box mb-[10px]">
        ...
        <div class="flex flex-col flex-1 min-h-0 info-box">
      ...
      <div class="content-right flex-1 info-box flex flex-col min-h-0 !p-0">
        <div class="px-4 pt-4 title shrink-0">当前监测点：{{ roomData.roomName }}</div>
        <equipment v-bind="monitorData" class="flex-1 min-h-0 mt-[8px] overflow-auto" />
      </div>
    </div>
  </el-dialog>
</template>
