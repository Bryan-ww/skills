...
// cylinderGeometry.computeFlatVertexNormals();
// color1、color2表示六光柱的颜色范围
let color1 = new THREE.Color('#76EEC6');
let color2 = new THREE.Color('#00CD00');
// 创建六光柱
function createColumn (h, percent, item) {
    const cylinderGeometry = new THREE.CylinderGeometry(1, 1, h, 6);
