  ...
  <div ref="container" class="player">
    ...
    <div class="player-buttons-box" id="buttonsBox">
      ...
      <div class="buttons-box-right">
        ...
        <span v-if="!fullscreen && !hideFullScreen" class="player-btn icon-full" @click="fullscreenSwich">全屏</span>
        <span v-if="fullscreen && !hideFullScreen" class="player-btn icon-not-full" @click="fullscreenSwich">退出全屏</span>
      </div>
    </div>
    <div class="kbps-btn-box">
      <div class="name-box">{{ videoName }}</div>
      <div class="kbps-btn">{{ kBps }} kb/s</div>
      <div v-if="showClose" class="close" @click="removeVideo">
        <el-icon>
          <Close />
        </el-icon>
      </div>
